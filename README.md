...
Dataset:
The dataset includes user IDs, movie IDs, movie category IDs, movie rating, review IDs, and review date.
...
Results:
Global Average: RMSE = 1.08, MAE = 0.83
Item-Based CF : RMSE = 1.00, MAE = 0.74
